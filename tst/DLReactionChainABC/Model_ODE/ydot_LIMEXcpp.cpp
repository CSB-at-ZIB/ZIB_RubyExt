...
c              ~~~~~~~~
c       Date : Fri Mar  4 11:42:22 2016
c              
...
void get_compartment_ids_ ( char (*idc)[MAXIDSTRLEN], int* ncom, int _len)
{
   *ncom = 1;
   ///
   std::strncpy(idc[  0],"default\0",_len);
   ///
}
//=======================================================================
void get_species_ids_ ( char (*ids)[MAXIDSTRLEN], int* nspe, int _len)
{
   *nspe = 3;
   ...
   ///
   std::strncpy(ids[  0],"A\0",_len);
   std::strncpy(ids[  1],"B\0",_len);
   std::strncpy(ids[  2],"C\0",_len);
   ///
}
//=======================================================================
void get_parameter_ids_ ( char (*idp)[MAXIDSTRLEN], int* npar, int _len)
{
   *npar = 4;
   ...
   ///
   std::strncpy(idp[  0],"global_k1\0",_len);
   std::strncpy(idp[  1],"global_k_1\0",_len);
   std::strncpy(idp[  2],"global_k2\0",_len);
   std::strncpy(idp[  3],"global_k_2\0",_len);
   ///
}
//=======================================================================
void get_model_ids_ ( char (*idm)[MAXIDSTRLEN], int* nid, int _len)
{
   *nid = 5;
   ...
   ///
   std::strncpy(idm[  0],"ChainABC\0",_len);
   std::strncpy(idm[  1],"Fri Mar  4 11:42:22 2016\0",_len);
   std::strncpy(idm[  2],"001457088142\0",_len);
   std::strncpy(idm[  3],"ChainABC.xml\0",_len);
   std::strncpy(idm[  4],"with vareq\0",_len);
   ///
}
//=======================================================================
};
